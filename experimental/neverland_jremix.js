...
function createJRemixer(context, jquery) {
    ...
    var remixer = {
        ...
        remixTrack : function(track, neverlandTrack, jukeboxData, callback) {
                     ...
                     if (false) {
                        ...
                        context.decodeAudioData(request.response, 
                            function(buffer) {      // completed function
                                ...
                                neverlandTrack.buffer = null;
                                request.open("GET", neverlandTrack.info.url, true);
                                request.responseType = "arraybuffer";
                                ...
                                request.onload = function() {
                                    ...
                                    if (false) {
                                        ...
                                        context.decodeAudioData(request.response,
                                            function(buffer) {      // completed function
                                                neverlandTrack.buffer = buffer;
                                                neverlandTrack.status = 'ok';

                                                callback(1, track, neverlandTrack, 100);
                                            },
            ...
            preprocessTrack(neverlandTrack);

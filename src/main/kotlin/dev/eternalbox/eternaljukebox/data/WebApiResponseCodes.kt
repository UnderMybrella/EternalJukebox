...
object WebApiResponseCodes {
    ...
    const val ANALYSIS_NOT_SUPPORTED = 2 or JUKEBOX_SERVER_ERROR_TYPE

    const val NO_AUDIO_PROVIDER = 10 or JUKEBOX_SERVER_ERROR_TYPE
    //    const val AUDIO_NOT_STORED = 11 or JUKEBOX_SERVER_ERROR_TYPE
    const val AUDIO_NOT_SUPPORTED = 12 or JUKEBOX_SERVER_ERROR_TYPE

    const val NO_INFO_PROVIDER = 20 or JUKEBOX_SERVER_ERROR_TYPE
    const val INFO_NOT_SUPPORTED = 22 or JUKEBOX_SERVER_ERROR_TYPE

...
class EternalRemixer(
    ...
    fun euclideanDistance(v1: DoubleArray, v2: DoubleArray, cap: Int = minOf(v1.size, v2.size)): Double {
        var sum = 0.0
    ...
    fun weightedEuclideanDistance(v1: DoubleArray, v2: DoubleArray): Double {
        var sum = 0.0
        // for (i in 0 until 4)
        for (i in v1.indices) {
            val delta = v2[i] - v1[i]
